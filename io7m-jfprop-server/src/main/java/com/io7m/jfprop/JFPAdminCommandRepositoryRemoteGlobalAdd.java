...
public final class JFPAdminCommandRepositoryRemoteGlobalAdd extends
  JFPAdminHandlerAbstract
{
  JFPAdminCommandRepositoryRemoteGlobalAdd(
      ...
      ServletException
  {
    ...
    try {
      ...
      transaction.repositoryAddGlobalRemote(remote);
