...
public final class JFPAdminCommandRemoteList extends JFPAdminHandlerAbstract
{
  JFPAdminCommandRemoteList(
      ...
      IOException
  {
    ...
    final byte[] e = JFPResponseUtilities.encodeMap(remotes);
