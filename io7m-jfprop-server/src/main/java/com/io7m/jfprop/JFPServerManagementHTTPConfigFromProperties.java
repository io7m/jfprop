...
public final class JFPServerManagementHTTPConfigFromProperties implements
  JFPServerManagementHTTPConfigType
{
  /**
  ...
  public static JFPServerManagementHTTPConfigType fromProperties(
    final Properties p)
    throws JPropertyException,
      ...
      AddressException
  {
    ...
    final InetSocketAddress a =
      new InetSocketAddress(address, server_management_port.intValue());
    return new JFPServerManagementHTTPConfigFromProperties(a);
  }
  ...
  public static
    ...
    fromPropertiesOptional(
      ...
      throws JPropertyException,
        ...
        AddressException
  {
    final boolean management_enabled =
    ...
    if (management_enabled) {
      return Option.some(JFPServerManagementHTTPConfigFromProperties
        .fromProperties(p));
    }
  ...
  private JFPServerManagementHTTPConfigFromProperties(
