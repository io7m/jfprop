...
public interface JFPRemoteControllerType
{
  /**
   ...
   * @param remote
   *          The remote to contact.
   * @return A future representing a call in progress, with <code>true</code>
   *         indicating a successful call.
   */

  Future<Boolean> doCommitNotify(
