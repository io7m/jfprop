 ...
 *
 * The {@link #matches(int)} function returns <code>true</code> iff
 * <code>x % c == 0</code> where <code>x</code> is the incoming value and
 * <code>c</code> is the component value.
 */
  ...
  JFPTimeComponentSpecType
{
  ...
  static {
    serialVersionUID = 8171086069286925474L;
  }
  ...
  public JFPTimeComponentSpecDivisible(
    final int in_value)
  {
    this.value =
